function craft_trial_spawner:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    {translate: "craft_trial_spawner.description", fallback: "Crafting recipes for Trial Spawner, Keys and Vaults"},\
    "",\
